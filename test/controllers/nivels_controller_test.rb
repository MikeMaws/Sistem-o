...
class NivelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nivel" do
    assert_difference('Nivel.count') do
      post nivels_url, params: { nivel: { descricao: @nivel.descricao, posicao: @nivel.posicao } }
    end
  ...
  test "should update nivel" do
    patch nivel_url(@nivel), params: { nivel: { descricao: @nivel.descricao, posicao: @nivel.posicao } }
