...
class HabilidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habilidade" do
    assert_difference('Habilidade.count') do
      post habilidades_url, params: { habilidade: { nome: @habilidade.nome, subtask_id: @habilidade.subtask_id } }
    end
  ...
  test "should update habilidade" do
    patch habilidade_url(@habilidade), params: { habilidade: { nome: @habilidade.nome, subtask_id: @habilidade.subtask_id } }
